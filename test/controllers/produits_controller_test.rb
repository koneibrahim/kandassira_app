...
class ProduitsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create produit" do
    assert_difference('Produit.count') do
      post produits_url, params: { produit: { nom_pro: @produit.nom_pro, prix: @produit.prix, qte_pro: @produit.qte_pro, type_pro: @produit.type_pro } }
    end
  ...
  test "should update produit" do
    patch produit_url(@produit), params: { produit: { nom_pro: @produit.nom_pro, prix: @produit.prix, qte_pro: @produit.qte_pro, type_pro: @produit.type_pro } }
