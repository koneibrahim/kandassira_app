...
class VentesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create vente" do
    assert_difference('Vente.count') do
      post ventes_url, params: { vente: { client_id: @vente.client_id, date_vente: @vente.date_vente, payee: @vente.payee, somme: @vente.somme } }
    end
  ...
  test "should update vente" do
    patch vente_url(@vente), params: { vente: { client_id: @vente.client_id, date_vente: @vente.date_vente, payee: @vente.payee, somme: @vente.somme } }
